 ...
 * @param timeLimit The time limit after which the stream will be cancelled
 */
...
object TimeLimitLifetimeService:
   ...
   * @param timeLimit The time limit after which the stream will be cancelled
   * @return The time limit lifetime service
   */
   ...
   * Uses a time limit of 10 seconds.
   * @return The ZLayer for the time limit lifetime service
   */
