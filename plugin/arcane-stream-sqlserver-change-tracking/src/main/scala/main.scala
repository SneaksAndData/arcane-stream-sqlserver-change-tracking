...
import com.sneaksanddata.arcane.framework.services.lakehouse.{IcebergS3CatalogWriter, IcebergSettings, S3CatalogFileIO}
...
object main extends ZIOAppDefault {
  ...
  def run: ZIO[Any, Throwable, Unit] =
    appLayer.provide(
      ...
      IcebergSettings.layer,
      ZLayer.succeed(S3CatalogFileIO)
    )
    .orDie
}
